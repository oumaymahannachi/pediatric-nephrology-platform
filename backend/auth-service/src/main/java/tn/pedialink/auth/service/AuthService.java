...
import tn.pedialink.auth.keycloak.KeycloakService;
...
public class AuthService {
    ...
    public ApiMessage signup(SignupRequest req) {
        ...
        keycloakService.createUser(req.getEmail(), req.getPassword(), role.name(), req.getFullName());
    ...
    public AuthResponse login(LoginRequest req, String ipAddress, String userAgent) {
        ...
        String token = keycloakService.getUserToken(req.getEmail(), req.getPassword());
    ...
    public ApiMessage resetPassword(ResetPasswordRequest req) {
        ...
        keycloakService.updatePassword(user.getEmail(), req.getNewPassword());
