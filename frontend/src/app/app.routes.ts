...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'prescriptions/scan', loadComponent: () => import('./features/prescription/ocr-scanner/ocr-scanner.component').then(m => m.OcrScannerComponent) },
      ...
      { path: 'dossier-medical', loadComponent: () => import('./features/dossier-medical/dossier-medical.component').then(m => m.DossierMedicalComponent) },
      { path: 'profile', loadComponent: () => import('./features/profile/edit-profile.component').then(m => m.EditProfileComponent) }
    ]
  },
  {
